    ...
    <main>
      ...
      {submitted ? (
        <div className="flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
          ...
          <p>Once it has been appoved, it will appear below!</p>
        </div>
      ) : (
        <form
        ...
        >
          ...
          <label className="block mb-5">
            ...
            <input
              ...
              className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 focus:ring outline-none"
              placeholder="johndog@puppies.com"
              type="text"
            />
          </label>
          <label className="block mb-5">
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 60, // update old cache version every after 60 seconds (ISR)
  };
};
